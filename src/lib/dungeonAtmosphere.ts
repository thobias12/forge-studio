...
const THEMES: Record<DungeonTheme, DungeonAtmosphere> = {
  crypt: { background:0x080b0a,fog:0x111716,fogMultiplier:0.98,sky:0x7c827c,ground:0x171916,ambient:1.14,key:0xc4c0b2,keyIntensity:0.92,exposure:1.04,bloomStrength:0.5,bloomRadius:0.5,bloomThreshold:0.82,floor:0x3f4541,wall:0x525954,wallDark:0x313632,corridorFloor:0x383e3a,corridorWall:0x454c47,seam:0x232824,torch:0xff9c58,torchIntensity:3.55,dust:0x777b73,mist:0x7f8e86,boss:0xa83a4d,shrine:0x68b9a9,treasure:0xd8ae58 },
...
export function tintRoomFloor(base:number,type:DungeonRoomType,atmosphere:DungeonAtmosphere){const color=new THREE.Color(base);const accent=roomAccent(type,atmosphere);if(accent!==undefined)color.lerp(new THREE.Color(accent),type==='boss'?0.16:0.075);if(type==='entrance')color.offsetHSL(0,-0.04,0.04);return color}
