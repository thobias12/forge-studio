...
const THEMES: Record<DungeonTheme, DungeonAtmosphere> = {
  crypt: { background:0x050708,fog:0x101415,fogMultiplier:0.44,sky:0x7d898c,ground:0x1d2020,ambient:0.79,key:0xb5c0c2,keyIntensity:0.44,exposure:1.18,bloomStrength:0.44,bloomRadius:0.46,bloomThreshold:0.73,floor:0x56534e,wall:0x625f59,wallDark:0x303331,corridorFloor:0x4d4b46,corridorWall:0x595650,seam:0x262826,torch:0xff9146,torchIntensity:4.35,dust:0x928b80,mist:0x65706e,boss:0x60373c,shrine:0x637871,treasure:0x796b56 },
