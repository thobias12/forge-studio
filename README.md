...
The generator setup expects a compatible Python 3.8–3.11 runtime. On Windows, Python 3.11 is preferred. NVIDIA PyTorch uses the CUDA 12.8 wheel in the Forge setup path.
