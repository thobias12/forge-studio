...
- the Body Fit Engine still samples the real Skillbound mannequin and transfers official skin weights automatically
- generator output metadata identifies `blender-equipment-grammar-v1`, recipe id and variation
- Equipment Lab UI now describes the recipe-driven pipeline directly
- processor health exposes the Equipment Grammar capability
- automated Blender QA generates all 3 styles × all 4 variations before release
...
1. Improve the shared Chest grammar itself:
   - garment silhouettes
   - neckline / armhole families
   - panel grammar
   - seams / trims
   - straps / belts / hardware
   - controlled asymmetry
   - material/detail density
2. Keep Ranger / Traveler / Acolyte as **recipes**, not separately modeled assets.
3. Make variations meaningfully different while preserving fit and deterministic output.
4. Expand the same generator architecture to the missing equipment families:
   - head
   - legs
   - boots
   - gloves
