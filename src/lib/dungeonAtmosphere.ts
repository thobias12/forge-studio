...
const THEMES: Record<DungeonTheme, DungeonAtmosphere> = {
  crypt: { background:0x03070b,fog:0x09121a,fogMultiplier:0.62,sky:0x607d99,ground:0x090e13,ambient:1.18,key:0x7897b5,keyIntensity:0.92,exposure:1.2,bloomStrength:0.27,bloomRadius:0.34,bloomThreshold:0.88,floor:0x24313b,wall:0x303d48,wallDark:0x151f28,corridorFloor:0x202b34,corridorWall:0x293640,seam:0x0f171e,torch:0xff9a55,torchIntensity:3.65,dust:0x536273,mist:0x344858,boss:0x703038,shrine:0x4e7481,treasure:0x947443 },
