...
const classic = layout('classic-arpg', {
  ...
  boss: module('boss', 'top-center', 0, 4.8, 1.08, 1, false),
...
const compact = layout('compact', {
  ...
  boss: module('boss', 'top-center', 0, 4.2, .98, 1, false),
...
const minimal = layout('minimal', {
  ...
  boss: module('boss', 'top-center', 0, 3.2, .98, 1, false),
...
const ultrawide = layout('ultrawide', {
  ...
  boss: module('boss', 'top-center', 0, 3.8, 1.08, 1, false),
