...
const THEMES: Record<DungeonTheme, DungeonAtmosphere> = {
  crypt: { background:0x071018,fog:0x101d28,fogMultiplier:0.42,sky:0x8faac1,ground:0x18222b,ambient:1.42,key:0xa5bdcf,keyIntensity:1.16,exposure:1.4,bloomStrength:0.3,bloomRadius:0.34,bloomThreshold:0.86,floor:0x42535f,wall:0x51616d,wallDark:0x26343e,corridorFloor:0x3b4a55,corridorWall:0x485966,seam:0x101820,torch:0xffa45f,torchIntensity:4.15,dust:0x718391,mist:0x4a6172,boss:0x6a343b,shrine:0x56818e,treasure:0xa28350 },
