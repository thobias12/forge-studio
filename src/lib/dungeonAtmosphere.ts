...
const THEMES: Record<DungeonTheme, DungeonAtmosphere> = {
  crypt: { background:0x03070b,fog:0x09121a,fogMultiplier:0.56,sky:0x6887a3,ground:0x0a1016,ambient:1.24,key:0x82a0bb,keyIntensity:0.98,exposure:1.26,bloomStrength:0.31,bloomRadius:0.37,bloomThreshold:0.86,floor:0x2b3944,wall:0x374651,wallDark:0x17232c,corridorFloor:0x26323c,corridorWall:0x30404a,seam:0x0d151c,torch:0xff9c58,torchIntensity:3.95,dust:0x5e6d7c,mist:0x3a4e5e,boss:0x74333b,shrine:0x527b89,treasure:0x9a7945 },
