...
const THEMES: Record<DungeonTheme, DungeonAtmosphere> = {
  crypt: { background:0x05080c,fog:0x0c141d,fogMultiplier:0.72,sky:0x607a92,ground:0x10161c,ambient:1.12,key:0x7995b0,keyIntensity:0.86,exposure:1.16,bloomStrength:0.22,bloomRadius:0.28,bloomThreshold:0.91,floor:0x2c3742,wall:0x35414c,wallDark:0x1b242c,corridorFloor:0x27323b,corridorWall:0x303b45,seam:0x141b21,torch:0xff9a57,torchIntensity:3.15,dust:0x596571,mist:0x3f5060,boss:0x743640,shrine:0x557d89,treasure:0x987a45 },
