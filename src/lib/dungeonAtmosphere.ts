...
const THEMES: Record<DungeonTheme, DungeonAtmosphere> = {
  crypt: { background:0x030609,fog:0x08121a,fogMultiplier:0.55,sky:0x6e8da8,ground:0x0d141b,ambient:1.28,key:0x8aa8c0,keyIntensity:1.02,exposure:1.3,bloomStrength:0.32,bloomRadius:0.36,bloomThreshold:0.84,floor:0x34434e,wall:0x3d4b57,wallDark:0x1b2731,corridorFloor:0x303d47,corridorWall:0x374650,seam:0x0c1319,torch:0xffa15c,torchIntensity:3.95,dust:0x617180,mist:0x3c5262,boss:0x663038,shrine:0x4e7886,treasure:0x9a7948 },
