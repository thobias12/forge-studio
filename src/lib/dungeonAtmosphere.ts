...
const THEMES: Record<DungeonTheme, DungeonAtmosphere> = {
  crypt: { background:0x050607,fog:0x0d0f10,fogMultiplier:0.56,sky:0x6c7072,ground:0x151617,ambient:0.86,key:0xb6b9b7,keyIntensity:0.58,exposure:1.08,bloomStrength:0.3,bloomRadius:0.36,bloomThreshold:0.86,floor:0x403f3d,wall:0x504e4a,wallDark:0x252522,corridorFloor:0x383735,corridorWall:0x46443f,seam:0x1f201f,torch:0xff8d46,torchIntensity:3.05,dust:0x777773,mist:0x4a4b49,boss:0x65363a,shrine:0x66706a,treasure:0x87765a },
